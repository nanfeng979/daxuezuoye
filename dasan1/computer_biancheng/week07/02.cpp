...
LRESULT CALLBACK WndProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_PAINT:
		...
		StretchBlt(hdc, 250, 20, bm.bmWidth * 2, bm.bmHeight * 2, hdcMem,
			0, 0, bm.bmWidth, bm.bmHeight, SRCCOPY); // 放大2倍
		StretchBlt(hdc, 20, 200, bm.bmWidth * 2 / 3, bm.bmHeight * 2 / 3, hdcMem,
			0, 0, bm.bmWidth, bm.bmHeight, SRCCOPY); // 放大2/3倍
		SetStretchBltMode(hdc, COLORONCOLOR);
		StretchBlt(hdc, 130, 200, bm.bmWidth * 2 / 3, bm.bmHeight * 2 / 3, hdcMem,
			0, 0, bm.bmWidth, bm.bmHeight, SRCCOPY); // 放大2/3倍并保真
